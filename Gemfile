...
description: >- # this means to ignore newlines until "baseurl:"
  ...
  The Project Vikram Journal is a project to make rural digitalization accessible, inclusive and democratized (as in equal opportunity not political). The project works on the digitalization of at least the following areas.
    1. Education
    2. Healthcare
